...
func _ready():
	...
	connect("connection_success", GameManager, "on_connection_success")
	connect("error_connection_failed", GameManager, "on_connection_error")
	connect("error_ssl_handshake", GameManager, "on_error_ssl_handshake")
